...
func (c *stanceServiceClient) Endorse(ctx context.Context, in *EndorseRequest, opts ...grpc.CallOption) (*EndorseResponse, error) {
	...
	err := c.cc.Invoke(ctx, StanceService_Endorse_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stanceServiceClient) GetUserStance(ctx context.Context, in *GetUserStanceRequest, opts ...grpc.CallOption) (*GetUserStanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, StanceService_GetUserStance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stanceServiceClient) CountStance(ctx context.Context, in *CountStanceRequest, opts ...grpc.CallOption) (*CountStanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, StanceService_CountStance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedStanceServiceServer must be embedded to have
...
func (UnimplementedStanceServiceServer) testEmbeddedByValue()                       {}
...
func RegisterStanceServiceServer(s grpc.ServiceRegistrar, srv StanceServiceServer) {
	// If the following call pancis, it indicates UnimplementedStanceServiceServer was
