...
func (c *courseServiceClient) SubscriptionList(ctx context.Context, in *SubscriptionListRequest, opts ...grpc.CallOption) (*SubscriptionListResponse, error) {
	...
	err := c.cc.Invoke(ctx, CourseService_SubscriptionList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *courseServiceClient) GetDetailById(ctx context.Context, in *GetDetailByIdRequest, opts ...grpc.CallOption) (*GetDetailByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, CourseService_GetDetailById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *courseServiceClient) GetSubscriberUidsById(ctx context.Context, in *GetSubscriberUidsByIdRequest, opts ...grpc.CallOption) (*GetSubscriberUidsByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, CourseService_GetSubscriberUidsById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *courseServiceClient) Subscribed(ctx context.Context, in *SubscribedRequest, opts ...grpc.CallOption) (*SubscribedResponse, error) {
	...
	err := c.cc.Invoke(ctx, CourseService_Subscribed_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *courseServiceClient) FindIdsOrUpsertByCourses(ctx context.Context, in *FindIdOrUpsertByCoursesRequest, opts ...grpc.CallOption) (*FindIdOrUpsertByCoursesResponse, error) {
	...
	err := c.cc.Invoke(ctx, CourseService_FindIdsOrUpsertByCourses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
